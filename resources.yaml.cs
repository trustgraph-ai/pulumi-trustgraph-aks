    ...
    template:
      ...
      spec:
        ...
        - command:
          ...
          - -p
          - pulsar://pulsar:6650
          image: docker.io/trustgraph/trustgraph-flow:1.0.22
          name: agent-manager
          resources:
            limits:
              cpu: '0.5'
...
- apiVersion: apps/v1
  ...
  spec:
    ...
    template:
      ...
      spec:
        containers:
        - image: docker.io/trustgraph/workbench-ui:0.3.10
          name: workbench-ui
          ports:
          - containerPort: 8888
            hostPort: 8888
