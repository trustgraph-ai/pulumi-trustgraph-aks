    ...
    template:
      ...
      spec:
        ...
        - command:
          ...
          - --log-level
          - DEBUG
          image: docker.io/trustgraph/trustgraph-flow:1.4.19
          name: agent-manager
          resources:
            limits:
              cpu: '0.5'
...
- apiVersion: v1
  data:
    config.json: '{"flow-classes": {"document-rag": {"class": {}, "description": "DocumentRAG
      ...
      "embeddings:{id}": {"request": "non-persistent://tg/request/embeddings:{id}",
      ...
      "order": 6, "type": "chunk-overlap"}, "chunk-size": {"advanced": true, "description":
      "Chunk size", "order": 5, "type": "chunk-size"}, "llm-model": {"advanced": false,
      ...
      3, "type": "llm-temperature"}}, "tags": ["document-rag"]}, "document-rag+graph-rag":
      {"class": {}, "description": "Supports GraphRAG and document RAG, no core creation",
      "flow": {"agent-manager:{id}": {"graph-rag-request": "non-persistent://tg/request/graph-rag:{id}",
      ...
      "non-persistent://tg/response/text-completion:{id}"}, "chunker:{id}": {"input":
      "persistent://tg/flow/text-document-load:{id}", "output": "persistent://tg/flow/chunk-load:{id}"},
      "de-query:{id}": {"request": "non-persistent://tg/request/document-embeddings:{id}",
      "response": "non-persistent://tg/response/document-embeddings:{id}"}, "de-write:{id}":
      {"input": "persistent://tg/flow/document-embeddings-store:{id}"}, "document-embeddings:{id}":
      {"embeddings-request": "non-persistent://tg/request/embeddings:{id}", "embeddings-response":
      "non-persistent://tg/response/embeddings:{id}", "input": "persistent://tg/flow/chunk-load:{id}",
      "output": "persistent://tg/flow/document-embeddings-store:{id}"}, "document-rag:{id}":
      {"document-embeddings-request": "non-persistent://tg/request/document-embeddings:{id}",
      "document-embeddings-response": "non-persistent://tg/response/document-embeddings:{id}",
      "embeddings-request": "non-persistent://tg/request/embeddings:{id}", "embeddings-response":
      "non-persistent://tg/response/embeddings:{id}", "prompt-request": "non-persistent://tg/request/prompt-rag:{id}",
      ...
      "document-rag+graph-rag+kgcore": {"class": {}, "description": "GraphRAG + DocumentRAG
      + knowledge core creation", "flow": {"agent-manager:{id}": {"graph-rag-request":
      ...
      "llm-temperature": {"advanced": true, "description": "LLM temperature", "order":
      3, "type": "llm-temperature"}}, "tags": ["document-rag", "graph-rag", "knowledge-extraction"]},
      "everything": {"class": {}, "description": "GraphRAG, DocumentRAG, structured
      data + knowledge cores", "flow": {"agent-manager:{id}": {"graph-rag-request":
      "non-persistent://tg/request/graph-rag:{id}", "graph-rag-response": "non-persistent://tg/response/graph-rag:{id}",
      "mcp-tool-request": "non-persistent://tg/request/mcp-tool:{id}", "mcp-tool-response":
      "non-persistent://tg/response/mcp-tool:{id}", "next": "non-persistent://tg/request/agent:{id}",
      "prompt-request": "non-persistent://tg/request/prompt:{id}", "prompt-response":
      ...
      {"advanced": true, "description": "Chunk overlap", "order": 6, "type": "chunk-overlap"},
      "chunk-size": {"advanced": true, "description": "Chunk size", "order": 5, "type":
      "chunk-size"}, "llm-model": {"advanced": false, "description": "LLM model",
      "order": 1, "type": "llm-model"}, "llm-rag-model": {"advanced": true, "controlled-by":
      "llm-model", "description": "LLM model for RAG", "order": 2, "type": "llm-model"},
      "llm-rag-temperature": {"advanced": true, "description": "LLM temperature for
      RAG", "order": 4, "type": "llm-temperature"}, "llm-temperature": {"advanced":
      true, "description": "LLM temperature", "order": 3, "type": "llm-temperature"}},
      "tags": ["document-rag", "graph-rag", "knowledge-extraction", "structured-data",
      "kgcore"]}, "graph-rag": {"class": {}, "description": "GraphRAG only", "flow":
      ...
      "graph-rag+agent-extract": {"class": {}, "description": "GraphRAG + agent extract",
      "flow": {"agent-manager:{id}": {"graph-rag-request": "non-persistent://tg/request/graph-rag:{id}",
      "graph-rag-response": "non-persistent://tg/response/graph-rag:{id}", "mcp-tool-request":
      "non-persistent://tg/request/mcp-tool:{id}", "mcp-tool-response": "non-persistent://tg/response/mcp-tool:{id}",
      "next": "non-persistent://tg/request/agent:{id}", "prompt-request": "non-persistent://tg/request/prompt:{id}",
      ...
      "llm-temperature": {"advanced": true, "description": "LLM temperature", "order":
      3, "type": "llm-temperature"}}, "tags": ["graph-rag", "knowledge-extraction",
      "agent-extract"]}, "graph-rag+structured-data": {"class": {}, "description":
      "GraphRAG + structured data", "flow": {"agent-manager:{id}": {"graph-rag-request":
      "non-persistent://tg/request/graph-rag:{id}", "graph-rag-response": "non-persistent://tg/response/graph-rag:{id}",
      "mcp-tool-request": "non-persistent://tg/request/mcp-tool:{id}", "mcp-tool-response":
      "non-persistent://tg/response/mcp-tool:{id}", "next": "non-persistent://tg/request/agent:{id}",
      "prompt-request": "non-persistent://tg/request/prompt:{id}", "prompt-response":
      ...
      RAG", "order": 4, "type": "llm-temperature"}, "llm-temperature": {"advanced":
      true, "description": "LLM temperature", "order": 3, "type": "llm-temperature"}},
      "tags": ["graph-rag", "knowledge-extraction", "structured-data"]}, "structured-data":
      {"class": {}, "description": "Structured data only", "flow": {"agent-manager:{id}":
      ...
      true, "description": "LLM temperature for RAG", "order": 4, "type": "llm-temperature"},
      "llm-temperature": {"advanced": true, "description": "LLM temperature", "order":
      3, "type": "llm-temperature"}}, "tags": ["knowledge-extraction", "structured-data"]}},
      "flows": {"default": {"class-name": "everything", "description": "Default processing
      ...
      "parameters": {"chunk-overlap": "50", "chunk-size": "2000", "llm-model": "azure",
      "llm-rag-model": "azure", "llm-rag-temperature": "0.300", "llm-temperature":
      "0.300"}}}, "flows-active": {"agent-manager": {"default": {"graph-rag-request":
      "non-persistent://tg/request/graph-rag:default", "graph-rag-response": "non-persistent://tg/response/graph-rag:default",
      "mcp-tool-request": "non-persistent://tg/request/mcp-tool:default", "mcp-tool-response":
      "non-persistent://tg/response/mcp-tool:default", "next": "non-persistent://tg/request/agent:default",
      "prompt-request": "non-persistent://tg/request/prompt:default", "prompt-response":
      "non-persistent://tg/response/prompt:default", "request": "non-persistent://tg/request/agent:default",
      "response": "non-persistent://tg/response/agent:default", "structured-query-request":
      "non-persistent://tg/request/structured-query:default", "structured-query-response":
      "non-persistent://tg/response/structured-query:default", "text-completion-request":
      "non-persistent://tg/request/text-completion:default", "text-completion-response":
      "non-persistent://tg/response/text-completion:default"}}, "chunker": {"default":
      {"input": "persistent://tg/flow/text-document-load:default", "output": "persistent://tg/flow/chunk-load:default"}},
      ...
      "embeddings": {"default": {"request": "non-persistent://tg/request/embeddings:default",
      "response": "non-persistent://tg/response/embeddings:default"}}, "ge-query":
      {"default": {"request": "non-persistent://tg/request/graph-embeddings:default",
      ...
      "request": "non-persistent://tg/request/structured-query:default", "response":
      "non-persistent://tg/response/structured-query:default"}}, "text-completion":
      {"default": {"model": "azure", "request": "non-persistent://tg/request/text-completion:default",
      "response": "non-persistent://tg/response/text-completion:default"}}, "text-completion-rag":
      {"default": {"model": "azure", "request": "non-persistent://tg/request/text-completion-rag:default",
      ...
      "required": true, "type": "integer"}, "llm-model": {"default": "azure", "description":
      "LLM model to use", "enum": [{"description": "Azure", "id": "azure"}], "required":
      true, "type": "string"}, "llm-temperature": {"default": 0.3, "description":
      "LLM temperature", "helper": "A floating point number between 0 and 1", "max":
      10, "min": 0, "placeholder": 0.3, "required": true, "type": "float"}}, "prompt":
      {"system": "You are a helpful assistant.", "template-index": ["agent-kg-extract",
      "agent-react", "diagnose-csv", "diagnose-json", "diagnose-structured-data",
      "diagnose-xml", "document-prompt", "extract-definitions", "extract-relationships",
      "extract-rows", "extract-topics", "graphql-generation", "kg-prompt", "question",
      "schema-selection"], "template.agent-kg-extract": {"prompt": "Analyze the following
      text and extract both entity definitions and relationships. Return the results
      as JSON with ''definitions'' and ''relationships'' arrays.\n\nFor definitions,
      extract entities and their explanations or descriptions.\nFor relationships,
      extract subject-predicate-object triples where subjects and objects are entities,
      and predicates are relationship types.\n\nText: {{text}}\n\nReturn JSON only,
      ...
      **Add preprocessing filters** to exclude invalid records\n7. **Include metadata**
      ...
      question\nand provided database schemas, generate a valid GraphQL query embedded
      in\nvalid JSON schema.\n\n## Question:\n{{ question }}\n\n## Provided Schemas:\n{%
      for schema in schemas %}\n**{{ schema.name }}**: {{ schema.description }}\nFields:\n{%
      for field in schema.fields %}\n- {{ field.name }} ({{ field.type }}){% if field.description
      %}: {{ field.description }}{% endif\n%}{% if field.primary_key %} [PRIMARY KEY]{%
      ...
      to retrieve (which fields to select)\n  - What filters to apply (where conditions)\n  -
      What sorting is needed (order_by, direction)\n  - How many results (limit)\n2.
      Generate a GraphQL query that:\n  - Uses only the provided schema names and
      field names\n  - Applies appropriate filters based on the question\n  - Selects
      relevant fields for the response\n  - Includes reasonable limits (default 100
      if not specified)\n3. If variables are needed, include them in the response\n\n###
      Response Format:\n\nReturn a JSON object with:\n- \"query\": the GraphQL query
      string\n- \"variables\": object with any GraphQL variables (empty object if
      none)\n- \"confidence\": float between 0.0-1.0 indicating confidence in the
      query\n\n### Example Responses:\n\nExample:\n**Question**: \"Show me customers
      from California\"\n{\n  \"query\": \"query { customers(where: {state: {eq: \\\"California\\\"}},
      limit: 100) { customer_id name email state} }\",\n  \"variables\": {},\n  \"confidence\":
      0.92\n}\n\nExample:\n**Question**: \"Top 10 products by price\"\n{\n  \"query\":
      \"query { products(order_by: \\\"price\\\", direction: DESC, limit: 10) { product_id
      name price category } }\",\n  \"variables\": {},\n  \"confidence\": 0.88\n}\n\nExample:\n**Question**:
      \"Recent orders over $100\"\n{\n  \"query\": \"query { orders( where: { total_amount:
      {gt: 100}, order_date: {gte: \\\"2024-01-01\\\"} }, order_by: \\\"order_date\\\",
      direction: DESC, limit: 50) { order_id customer_id total_amount order_date status
      } }\",\n  \"variables\": {},\n  \"confidence\": 0.96\n}\n\n}\n\n", "response-type":
      "json", "schema": {"additionalProperties": false, "properties": {"confidence":
      {"description": "Float between 0.0-1.0 indicating confidence in the generated
      query", "maximum": 1, "minimum": 0, "type": "number"}, "query": {"description":
      "The GraphQL query string generated to answer the question", "type": "string"},
      "variables": {"additionalProperties": true, "description": "Object containing
      any GraphQL variables needed for the query", "type": "object"}}, "required":
      ["query", "variables", "confidence"], "type": "object"}}, "template.kg-prompt":
    ...
    template:
      ...
      spec:
        ...
        - command:
          ...
          image: docker.io/trustgraph/trustgraph-mcp:1.4.19
          name: mcp-server
          ports:
          - containerPort: 8000
            hostPort: 8000
...
- apiVersion: apps/v1
  ...
  spec:
    ...
    template:
      ...
      spec:
        containers:
        - image: docker.io/trustgraph/workbench-ui:1.2.4
          name: workbench-ui
          ports:
          - containerPort: 8888
            hostPort: 8888
